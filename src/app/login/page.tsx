...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-white p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 -right-40 w-96 h-96 bg-blue-50 rounded-full mix-blend-multiply filter blur-3xl opacity-50" />
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gray-100 rounded-full mix-blend-multiply filter blur-3xl opacity-50" />

      <div className="w-full max-w-md relative z-10">
        {/* Logo */}
        <div className="text-center mb-8">
          <img src="/logo.png" alt="CampusMeals" className="w-20 mx-auto mb-4" />
          <h1 className="text-3xl font-bold tracking-tight text-black">CampusMeals</h1>
          <p className="text-gray-500 mt-2">Track your food journey</p>
        </div>
